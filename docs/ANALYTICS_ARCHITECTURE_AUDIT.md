...
| Mentorship | `/mentorship`, `/mentorship/[mentorId]`, `/profile?tab=mentor`, `/profile?tab=mentorships` | `mentorship_viewed`, `mentorship_request_started`, `mentorship_request_completed`; never send goals, notes, accessibility text, or private discussions |
