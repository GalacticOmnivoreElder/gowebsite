...
| QA-AN-015 | Mentorship | Request measurable | Eligible Community or Business member | Open mentorship and submit a request | Start/completion events contain no goals, notes, or private text | Automated + Manual | Not Run |
...
| QA-AN-017 | Support | Native request readiness | Eligible paid-through member | Create a support request in Profile | GO records the request before any optional Jira synchronization; no message or attachment data is sent to analytics | Automated + Manual | Not Run |
