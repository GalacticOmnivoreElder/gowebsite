...
import CourseBootcampAdmin from "@/components/admin/CourseBootcampAdmin";
...
export default function AdminLearningPage() {
  ...
  const load = useCallback(async () => {
    ...
    setItems(itemsResult.filter(item => !item.courseId));
