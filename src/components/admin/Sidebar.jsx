...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { name: "Project access & releases", href: "/admin/project-access", icon: FolderOpen },
    { name: "Subscriptions", href: "/admin/subscriptions", icon: CreditCard },
    { name: "Packages", href: "/admin/packages", icon: Package },
    { name: "Learning", href: "/admin/learning", icon: GraduationCap },
    { name: "Learning questions", href: "/admin/learning-questions", icon: GraduationCap },
    { name: "Mentor resources", href: "/admin/mentor-resources", icon: GraduationCap },
