...
export const EMAIL_EVENTS = Object.freeze({
  ...
  "learning.enrollment_confirmed": { category: EMAIL_CATEGORIES.ESSENTIAL },
  "learning.enrollment_pending": { category: EMAIL_CATEGORIES.ESSENTIAL },
  "learning.waitlisted": { category: EMAIL_CATEGORIES.ESSENTIAL },
  "learning.waitlist_promoted": { category: EMAIL_CATEGORIES.ESSENTIAL },
  "learning.enrollment_canceled": { category: EMAIL_CATEGORIES.ESSENTIAL },
  "learning.announcement": { category: EMAIL_CATEGORIES.PRODUCT },
  "training.assignment": { category: EMAIL_CATEGORIES.ESSENTIAL },
  "mentorship.request_received": { category: EMAIL_CATEGORIES.ESSENTIAL },
  "mentorship.response": { category: EMAIL_CATEGORIES.ESSENTIAL },
  "mentorship.scheduling": { category: EMAIL_CATEGORIES.ESSENTIAL },
  "mentorship.update": { category: EMAIL_CATEGORIES.ESSENTIAL },
  "mentorship.feedback": { category: EMAIL_CATEGORIES.ESSENTIAL },
  "asset_pack.review_update": { category: EMAIL_CATEGORIES.PRODUCT },
