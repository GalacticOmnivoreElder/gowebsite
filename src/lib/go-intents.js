export const GO_INTENTS = Object.freeze({
  ...
  'find-team': { pillar: 'portfolio', label: 'Find a team', description: 'Find collaborators in open project roles or start your included creator project.', href: '/membership?intent=find-team', continueTo: '/projects?intent=find-team' },
...
export function clearGoIntent() {
  if (typeof window === 'undefined') return;
  try { localStorage.removeItem('go.intent.v1'); } catch { /* Navigation works without storage. */ }
}
